...
export type ContractContext = Web3ContractContext<
  TokenType,
  TokenTypeMethodNames,
  TokenTypeEventsContext,
  TokenTypeEvents
>;
export type TokenTypeEvents = 'Approval' | 'Transfer';
export interface TokenTypeEventsContext {
  Approval(
    parameters: {
...
export type TokenTypeMethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
